    ...
    <#import "/cms/common/page.ftl" as lq>
     ...
     <div id="page-wrapper">
        <div id="page-inner" style="margin-top: 65px;">
		    ...
		    <div class="tools">
		    	<ul class="toolbar1">
		        <li class="click"><span><img src="/yydzblmanasys/static/img/t01.png" onclick="window.location.href='/yydzblmanasys/page/cms/addPatient';" /></span>
		        	<a href="/yydzblmanasys/page/cms/addPatient">添加</a>
		        </li>
		      </ul>
		    ...
		    <table class="tablelist">
		        ...
		        <tbody>
		        	<#list pagemodel.list as user>
				        ...
				        <td>
				        	<a href="/yydzblmanasys/view/getPatientMedicalRecord?id=${user['id']}" target="rightFrame" class="tablelink">查看历史病历</a>  
					        <a href="/yydzblmanasys/view/updatePatientData?id=${user['id']}" target="rightFrame" class="tablelink">修改</a>     
					        <a href="javascript:void(0)" class="tablelink" onclick="if(confirm('确定删除么？')){location.href='/yydzblmanasys/view/deletePatient?id=${user['id']}'; return true}"> 删除</a>
				        </td>
				        </tr> 
				     </#list>   
		        </tbody>
		    ...
		    <div class="pagin">
		    	<@lq.page rows="${pagemodel.rows}" url="/yydzblmanasys/view/patientsManage" cpage="${pagemodel.cpage}" pageSize="8"  totalpage="${pagemodel.totalpage}"/>
		    </div>
