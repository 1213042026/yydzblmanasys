    ...
    <#import "/cms/common/page.ftl" as lq>
     ...
     <div id="page-wrapper">
        <div id="page-inner" style="margin-top: 65px;">
		    ...
		    <table class="tablelist">
		        ...
		        <tbody>
		        	<#list pagemodel.list as medicalRecord>
				        ...
				        <td>
				        	<a href="/yydzblmanasys/view/getMedicalRecordDetail?id=${medicalRecord['id']}&patient=${medicalRecord['patient']}&doctor=${medicalRecord['doctor']}&patientId=${id}" target="rightFrame" class="tablelink">查看</a>  
				        </td>
				        </tr> 
				     </#list>   
		        </tbody>
		    ...
		    <div class="pagin">
		    	<@lq.page rows="${pagemodel.rows}" url="/yydzblmanasys/view/getPatientMedicalRecord" cpage="${pagemodel.cpage}" pageSize="8"  totalpage="${pagemodel.totalpage}" id="${id}" />
		    </div>
